...
const translations = {
  en: {
    ...
    project1_description: "Expense Tracker built with Angular, Spring Boot, and MySQL.",
    project2: "Text Synth",
  ...
  es: {
    ...
    project1_description: "Expense Tracker desarrollado con Angular, Spring Boot y MySQL.",
